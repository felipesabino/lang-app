...
import { Story } from "../storyTextBlock";
...
export const rootMachine = createMachine<MachineContext>(
  {
    ...
    states: {
      ...
      "story-failure": {
        ...
        on: {
          FETCH: {
            target: "story-pending",
          },
        },
      },
      "story-data-ready": {
        initial: "story-parsing",
        states: {
          "story-parsing": {
            on: {
              FORMAT: {
                target: "story-formating",
              },
            },
          },
          "story-reading": {
              ...
              text: {
                ...
                states: {
                  ...
                  "text-selected": {
                    on: {
                      HIGHLIGHT: {
                        target: "text-highlight-pending",
                      },
                      FETCH: {
                        target: "text-info-pending",
                      },
                    },
                  },
                  ...
                  "text-info-pending": {
                    on: {
                      SUCCESSFUL: {
                        target: "info successful",
                      },
                      ERROR: {
                        target: "itext--nfo-failed",
                      },
                    },
                  },
                  "info successful": {
